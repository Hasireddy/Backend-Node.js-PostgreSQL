...
const pool = new Pool();
const cors = require('cors'); //connecting backend to frontend.
app.use(express.json()); //To parse the body.
app.use(express.urlencoded({ extended: true })); //data updated in the frontend is received in the backend.
app.use(cors());
